  ...
  <div class="col-12">
    ...
    <section class="row coverPhoto p-0  border border-info rounded mb-4">
      <div class="col-12 col-md-6 text-light d-flex flex-column justify-content-center p-5">
        <p class="fs-2"> Get ahead of the scalpers.</p>
        <p class="fs-2"> Reserve your seat now with</p>
        <p class="fs-2"> real events for real people.</p>
      </div>
    </section>
